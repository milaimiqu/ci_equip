    ...
    <head>
        ...
        <script language="javascript" type="text/javascript">
               ...
               if($("#select1").val()==1)
                {
                    ...
                    window.location.href="<?php echo base_url();?>index.php/acfilling/index/0/"+$("#select1").val()+"/"+$("#starttime").val()+"/"+$("#endtime").val();
                }
                ...
                else if($("#select1").val()==3)
                {
                    ...
                    else
                    {
                        ...
                        window.location.href="<?php echo base_url();?>index.php/acfilling/index/0/"+$("#select1").val()+"/"+$("#vin").val();
                    }
                }
            }
            ...
            function excel()
            {
                ...
                {
                    window.location.href="<?php echo base_url();?>index.php/acfilling/excel/"+st+"/"+et;
                }
            }
        ...
        <div class="col-md-12 column">
            ...
            <div class="col-md-2 column">
                <form class="bs-example bs-example-form" role="form">
                    <div class="input-group">
                        ...
                        <input class="form-control select" id=vin name=vin value="" type="text"/>
                    </div>
                </form>    
            </div>
            ...
            <div class="col-md-12 column">
                            <table class="table table-bordered" style="font-size:12px;text-align:center">
                                    <thead>
                                        <tr>
                                            <th>序号</th><th>VIN</th><th>车型</th><th>真空值</th><th>保压泄露</th><th>加注量</th><th>循环时间</th><th>加注结果</th><th>加注时间</th><th>上传时间</th><th>设备名称</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
