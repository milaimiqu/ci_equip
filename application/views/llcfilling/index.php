    ...
    <head>
        ...
        <script language="javascript" type="text/javascript">
               ...
               if($("#select1").val()==1)
                {
                    ...
                    window.location.href="<?php echo base_url();?>index.php/llcfilling/index/0/"+$("#select1").val()+"/"+$("#starttime").val()+"/"+$("#endtime").val()+"/"+$("#vin").val();
                }
                ...
                else if($("#select1").val()==3)
                {
                    ...
                    else
                    {
                        ...
                        window.location.href="<?php echo base_url();?>index.php/llcfilling/index/0/"+$("#select1").val()+"/"+$("#vin").val();
                    }
                }
            }
            ...
            function excel()
            {
                ...
                {
                    window.location.href="<?php echo base_url();?>index.php/llcfilling/excel/"+st+"/"+et;
                }
            }
        ...
        <div class="col-md-12 column">
            ...
            <div class="col-md-12 column">
                            <table class="table table-bordered" style="font-size:12px;text-align:center">
                                    <thead>
                                        <tr>
                                            <th>序号</th><th>VIN</th><th>车型</th><th>真空1</th><th>真空泄露</th><th>真空2</th><th>主加注量</th><th>加注压力</th><th>副加注量</th><th>循环时间</th><th>加注结果</th><th>加注时间</th><th>上传时间</th><th>设备名称</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                            for($i=0;($i<10)&&isset($table[$i]['ID']);$i++)
                                            {
                                                ...
                                                echo "<td>".$table[$i]['VACUUM2']."</td>";
                                                echo "<td>".$table[$i]['FILL']."</td>";
                                                echo "<td>".$table[$i]['FILLPRE']."</td>";
                                                echo "<td>".$table[$i]['FILL2']."</td>";
