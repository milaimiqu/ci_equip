<?php
class brakefilling_model extends CI_Model{
    ...
    public function creat_excel($starttime,$endtime)
    {
        ...
        header("Content-Disposition:filename=制动液加注记录".$starttime."-".$endtime.".csv");
        
        $this->db->query("SET NAMES 'utf8'");
        
        $sql="select * from brakefilling where `INPUT_TIME` between '".$starttime."' and '".$endtime."'";
        $query=$this->db->query($sql);
        $row=$query->result_array();
